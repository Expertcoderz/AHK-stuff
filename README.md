...
Each executable was compiled using Ahk2Exe (with [UPX](https://upx.github.io/) for compression). The respective application icon used is available alongside under the mini-project's folder.
